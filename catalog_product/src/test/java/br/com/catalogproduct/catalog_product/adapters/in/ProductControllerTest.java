...
public class ProductControllerTest {
    ...
    public void createProduct_WithValidData_ReturnProduct() {
        ...
        ResponseEntity<?> response = productController.createProduct(PRODUCT_REQUEST, bindingResult);
    ...
    public void createProduct_WithNullData_ThrowException() {
        ...
        ResponseEntity<?> response = productController.createProduct(PRODUCT_REQUEST_NULL, bindingResult);
    ...
    public void updateProduct_WithValidData_ReturnProduct() {
        ...
        ResponseEntity<?> response = productController.updateProduct(PRODUCT_REQUEST, 2L, bindingResult);
    ...
    public void updateProduct_WithNullData_ThrowException() {
        ...
        ResponseEntity<?> response = productController.updateProduct(PRODUCT_REQUEST_NULL, 2L, bindingResult);
        Map<String, String> errors = (Map<String, String>) response.getBody();
